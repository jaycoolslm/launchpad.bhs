<script lang="ts">
    ...
    onMount(async () => {
        ...
        hashconnect = (await import("$lib/hashconnect/hashconnect")).default;
        appMetadata = (await import("$lib/hashconnect/hashconnect"))
            .appMetadata;
    ...
    const handleSelectWallet = (e: Event) => {
        e.preventDefault();
